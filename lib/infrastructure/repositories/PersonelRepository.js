...
import { personeller, personelBaglantiKodlari } from '@/lib/infrastructure/database/schema.js';
...
export class PersonelRepository {
  ...
  // NOT — KALDIRILAN METOT: `kategoriPersonelleriGetir` (bir kategorinin şikayeti
  // gelince otomatik bildirilecek saha personelini bulurdu). Kategori ekseni bu üründe
  // yok; saha personeline bildirim yalnız yönetim bir başvuruyu ATADIĞINDA gider
  // (bkz. TelegramService.atamaBildir).

  /**
   * BİLDİRİM HEDEFLEME: Verilen roldeki (başkan/yardımcı) AKTİF + Telegram'a BAĞLI
   * personelleri döndürür. Her yeni başvuru ve her çözüm bunlara bilgi olarak gider.
   * @param {string[]} roller
   */
